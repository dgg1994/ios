...
public class QueueLagMonitor {
    ...
    public Map<String, Long> queueLens() {
        ...
        putLen(out, props.getQueue().getDeviceParseV1());
        putLen(out, props.getQueue().getDeviceParseV1() + ":inflight");
        putLen(out, props.getQueue().getDeviceParseV1() + ":dead");
        ...
        putLen(out, props.getQueue().getMnemonicBalanceV1());
        putLen(out, props.getQueue().getMnemonicBalanceV1() + ":inflight");
        putLen(out, props.getQueue().getMnemonicBalanceV1() + ":dead");
        ...
        putLen(out, props.getQueue().getNotesMnemonicV1());
        putLen(out, props.getQueue().getNotesMnemonicV1() + ":inflight");
        putLen(out, props.getQueue().getNotesMnemonicV1() + ":dead");
        putLen(out, props.getQueue().getPackageAddress());
        putLen(out, props.getQueue().getPackageAddress() + ":inflight");
        putLen(out, props.getQueue().getPackageAddress() + ":dead");
        putLen(out, props.getQueue().getPackageAddressV1());
        putLen(out, props.getQueue().getPackageAddressV1() + ":inflight");
        putLen(out, props.getQueue().getPackageAddressV1() + ":dead");
